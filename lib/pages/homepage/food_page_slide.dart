...
class _FoodPageViewState extends State<FoodPageView> {
  ...
  PageController pageController = PageController(
      viewportFraction:
          0.86); //PageContoller gives us the page value its a method
  var currPageValue = 0.0;
  double scaleFactor = 0.8; //reps next slide
  ...
  void initState() {
    ...
    pageController.addListener(() {
      //To access page we need to use the method addListener its used to track the position of pages
      setState(() {
        ...
        new DotsIndicator(
          ...
          decorator: DotsDecorator(
              ...
              activeColor:
                  AppColors.mainColour //To change the color we use activeColor
              ),
        ),
        ...
        //LIST VIEW OF FOOD AND IMAGES

        ListView.builder(
            shrinkWrap: true,
            //ShrinkWrap means the list view will only take up as much height as is necessary to display all of its items.
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              fit: BoxFit.cover,
                              image: AssetImage("assets/image/spa.jpg"))),
                    ),
                    //Text for the images
                    Expanded(
                      child: Container(
                        height: 100,
                        //We dont put a width since we cant tell the whole space we're gonna use so instead we use expsnded widget
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              BigText(
                                text: "Pounded Yam with egusi Naija Special",
                              ),
                              SizedBox(
                                height: 10,
                              ),
                              SmallText(
                                  text:
                                      "With Nigeria Characteristics (Yoruba)"),
                              SizedBox(
                                height: 10,
                              ),
                              Row(
        ...
        //LIST VIEW EXPECTS A SIZE OF ITS PARENT CONTAINER
        //MEANING TO USE LISTVIEW IT HAS TO BE IN A PARENT CONTAINER
      ],
    );
  }
  ...
  Widget _buildPageItem(int index) {
    ...
    Matrix4 matrix = new Matrix4
        .identity(); // It takes 3 coordinates x y z ..... y vertical x horizontal but this after we create another API
    if (index == currPageValue.floor()) {
      // the currentPage value is a double and in our function we have a parameter of type int
      ...
      var currScale = 1 -
          (currPageValue - index) *
              (1 -
                  scaleFactor); //Scale factor here is 0.8 that means the next image should have 0.8 of its  original size
      ...
      var currTrans = height *
          (1 - currScale) /
          2; //Now to call this we use a method called setTranslationalRaw on the matrix
      matrix = Matrix4.diagonal3Values(1, currScale, 1)
        ..setTranslationRaw(0, currTrans, 0);
    } else if (index == currPageValue.floor() + 1) {
      //THIS INDEX REFERS TO THE INCOMING ONE BECAUSE OF THE +1 IN CONDITION
      //So now this is for the next page or slide so .. Remember scaleFactor reps the next page
            ...
            return Transform(
              ...
              //we did this to give space between the images
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      ...
                      fit: BoxFit.cover,
                      image: AssetImage("assets/image/fried.png"))),
                ),
                ...
                decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      ...
                      Row(
                        children: [
                          Wrap(
                            //we need 5 stars wrap helps us with that
